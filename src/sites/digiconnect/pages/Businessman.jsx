      ...
      <div className="max-w-7xl mx-auto py-2 md:py-4 px-8">
        <div className="grid grid-cols-1">
          {offeringPageData.map((data, index) => (
            <div
              key={index}
              className="flex flex-col md:flex-row items-start md:gap-6 transform transition-transform duration-500 my-10"
            >
              <motion.div
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4 md:gap-y-0 md:gap-x-6 md:w-2/3 my-10 md:my-0">
                <motion.div
                  variants={fadeIn("up", 0.2)}
                  initial="hidden"
                  whileInView="show"
