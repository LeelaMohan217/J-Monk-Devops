        ...
        >
          <div className="flex flex-col gap-2 rounded-xl border border-neutral-200 bg-surface p-2 shadow-sm sm:flex-row sm:items-center">
            ...
            <button
              type="submit"
              disabled={!hasRoles}
              className={`inline-flex shrink-0 items-center justify-center gap-2 rounded-lg bg-red-600 px-6 font-medium text-white transition-colors duration-300 hover:bg-red-700 focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-red-600 disabled:cursor-not-allowed disabled:bg-neutral-300 ${CONTROL} !text-white`}
            >
              Search
            </button>
          </div>
        ...
        {hasRoles ? (
          ...
          >
            ...
            <Link
              ...
              className="group mt-8 inline-flex items-center gap-2 rounded-lg bg-red-600 px-6 py-3 text-sm font-medium text-white transition-colors duration-300 hover:bg-red-700 focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-red-600"
            >
              {emptyState.ctaLabel}
              <ArrowRight
