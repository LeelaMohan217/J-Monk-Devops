...
// Same numbered editorial row pattern as home/ServicesSection — no eyebrow
// header of its own here since PageHeaderSection above already carries it.
      ...
      <div className="mx-auto max-w-7xl px-6 md:px-8">
        {services.map((service, index) => (
          <motion.article
            ...
            className="border-t border-neutral-200 py-10 first:border-t-0 last:border-b md:py-14"
          >
