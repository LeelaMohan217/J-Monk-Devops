...
const connects = [
  ...
  { name: "SkillConnect", href: "/skillconnect", available: false },
  { name: "EduConnect", href: "/educonnect", available: false },
];

const GlobalNav = () => {
  return (
    <header className="sticky top-0 z-[60] bg-white border-b border-neutral-200 shadow-sm">
